    ...
    return(
        <div className="aboutMe" id="aboutMe">
            ...
            <div className="aboutMeContainer">
                <>
                <div className="aboutMePattern patternNode">
                    <img src="./images/node.svg" alt="node.js" className="aboutMeVectorImg"/>
                </div>
                <div className="aboutMePattern patternJavaScript">
                    <img src="./images/js.svg" alt="js" className="aboutMeVectorImg"/>
                </div>
                <div className="aboutMePattern patternMongodb">
                    <img src="./images/mongodb.svg" alt="mongo" className="aboutMeVectorImg"/>
                </div>
                <div className="aboutMePattern patternReact">
                    <img src="./images/react.svg" alt="python" className="aboutMeVectorImg"/>
                </div>
                </>
                <div className="aboutMeCodingText">{textAboutMe[0]}</div>
